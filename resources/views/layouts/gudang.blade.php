...
<head>
  ...
  <header class="main-header">
    <a href="{{ route('home_gudang') }}" class="logo">
  ...
  <aside class="main-sidebar control-sidebar-dark">
    <!-- <div class="user-panel"> -->
        ...
        <!-- <div class="pull-left info">
          <p>{{ $nama }}</p>
          <a href="{{ route('home_gudang') }}"><i class="fa fa-circle text-success"></i> Online</a>
        </div> -->
        <!-- <br/>
        <br/>
        <br/>
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li>
          <a href="{{ route('home_gudang') }}">
            <i class="fa fa-home"></i> <span>Home</span>
          </a>
        </li>
        <li>
          <a href="{{ route('data_gas') }}">
            <i class="fa fa-list"></i> <span>Data Produk</span>
          </a>
        </li>
        <li>
          <a href="{{ route('data_histori') }}">
            <i class="fa fa-list"></i> <span>Data Laporan Produk</span>
          </a>
        </li>
        <li>
          <a href="{{ route('logout_gudang') }}">
