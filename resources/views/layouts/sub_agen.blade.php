...
<head>
  ...
  <header class="main-header">
    <a href="{{ route('home_sub_agen') }}" class="logo">
  ...
  <aside class="main-sidebar control-sidebar-dark">
    <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>{{ $nama }}</p>
          <a href="{{ route('home_sub_agen') }}"><i class="fa fa-circle text-success"></i> Online</a>
        </div>
        <br/>
        <br/>
        <br/>
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li>
          <a href="{{ route('home_sub_agen') }}">
            <i class="fa fa-home"></i> <span>Home</span>
          </a>
        </li>
        <li>
          <a href="#">
            <i class="fa fa-book"></i> <span>Data Pemesanan</span>
          </a>
        </li>
        <li>
          <a href="#">
            <i class="fa fa-book"></i> <span>Riwayat Transaksi</span>
          </a>
        </li>
        <li>
