    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="{{ route('index') }}" class="navbar-brand"><b>PT. GASINDO CIREBON</b> PRIMA</a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="{{ route('produk') }}">Produk <span class="sr-only">(current)</span></a></li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <!-- Menu Toggle Button -->
              <a href="{{ route('form_login') }}"><i class="fa fa-sign-in"></i>
